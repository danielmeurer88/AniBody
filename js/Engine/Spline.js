 ...
 * @returns {undefined}
 */
Spline.prototype.AddPoint = function (porx, y) {
 ...
 * @see README_DOKU.txt
 */
Spline.prototype.Draw = function (c) {
    c.save();
...
Spline.prototype.SetDash = function (active, length, space) {
...
Spline.prototype.SetColor = function (color) {
    this.Color = color;
};
 ...
 * @returns {undefined}
 */
Spline.prototype.CircularSort = function (base, sortGap) {
 ...
 */
Spline.prototype._getAngle = function (base, p, resultGap) {
 ...
 * @returns {Number}
 */
Spline.prototype._getDistance = function (base, p) {
    var dx = p.x - base.x;
    var dy = p.y - base.y;
 ...
 * @returns {Array}
 */
Spline.prototype._getFirstControlPoints = function (rhs) {
    var n = rhs.length;
